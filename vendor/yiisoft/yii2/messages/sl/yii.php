...
return [
    ...
    'No' => 'Ne',
<<<<<<< HEAD
    'No helper for unknown command "{command}".' => 'Pomoči za neznani ukaz "{command}" ni mogoče najti.',
    'No helper for unknown sub-command "{command}".' => 'Pomoči za neznani pod-ukaz "{command}" ni mogoče najti.',
=======
